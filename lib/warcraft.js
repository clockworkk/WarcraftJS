 ...
 *
 */
 //TODO when this is given multiple params this.queryString returns undefined
 ...
 *
 */
Warcraft.prototype.getItemData = function(itemId, locale, error, success) {
	var path = '/wow/item/' + itemId + '?locale=' + locale;
	var url = this.baseUrl + path;
	return this.doGet(url, error, success);
};
...
Warcraft.prototype.getPVPData = function(bracket, locale, error, success) {
	var path = '/wow/leaderboard/' + bracket + '?locale=' + locale;
	var url = this.baseUrl + path;
	return this.doGet(url, error, success);
};


Warcraft.prototype.getQuestData = function(questId, locale, error, success) {
	var path = '/wow/quest/' + questId + '?locale=' + locale;
	var url = this.baseUrl + path;
	return this.doGet(url, error, success);
};
...
Warcraft.prototype.getRecipeData = function(recipeId, locale, error, success) {
	var path = '/wow/recipe/' + recipeId + '?locale=' + locale;
	var url = this.baseUrl + path;
	return this.doGet(url, error, success);
};


Warcraft.prototype.getSpellData = function(spellId, locale, error, success) {
	var path = '/wow/spell/' + spellId + '?locale=' + locale;
	var url = this.baseUrl + path;
	return this.doGet(url, error, success);
};


Warcraft.prototype.getBattleGroupsData = function(locale, error, success) {
	var path = '/wow/data/battlegroups' + '?locale=' + locale;
	var url = this.baseUrl + path;
	return this.doGet(url, error, success);
};


Warcraft.prototype.getCharacterRacesData = function(locale, error, success) {
	var path = '/wow/data/character/races' + '?locale=' + locale;
	var url = this.baseUrl + path;
	return this.doGet(url, error, success);
};


Warcraft.prototype.getCharacterClassesData = function(locale, error, success) {
	var path = '/wow/data/character/classes' + '?locale=' + locale;
	var url = this.baseUrl + path;
	return this.doGet(url, error, success);
};


Warcraft.prototype.getAllAchievementsData = function(locale, error, success) {
	var path = '/wow/data/character/achievements' + '?locale=' + locale;
	var url = this.baseUrl + path;
	return this.doGet(url, error, success);
};


Warcraft.prototype.getGuildRewardsData = function(locale, error, success) {
	var path = '/wow/data/guild/rewards' + '?locale=' + locale;
	var url = this.baseUrl + path;
	return this.doGet(url, error, success);
};


Warcraft.prototype.getGuildPerksResourcesData = function(locale, error, success) {
	var path = '/wow/data/guild/perks' + '?locale=' + locale;
	var url = this.baseUrl + path;
	return this.doGet(url, error, success);
};


Warcraft.prototype.getGuildAchievementsResourcesData = function(locale, error, success) {
	var path = '/wow/data/guild/achievements' + '?locale=' + locale;
	var url = this.baseUrl + path;
	return this.doGet(url, error, success);
};


Warcraft.prototype.getItemClassesData = function(locale, error, success) {
	var path = '/wow/data/item/classes' + '?locale=' + locale;
	var url = this.baseUrl + path;
	return this.doGet(url, error, success);
};


Warcraft.prototype.getTalentData = function(locale, error, success) {
	var path = '/wow/data/talents' + '?locale=' + locale;
	var url = this.baseUrl + path;
	return this.doGet(url, error, success);
};


Warcraft.prototype.getPetTypesData = function(locale, error, success) {
	var path = '/wow/data/pet/types' + '?locale=' + locale;
	var url = this.baseUrl + path;
	return this.doGet(url, error, success);
};
